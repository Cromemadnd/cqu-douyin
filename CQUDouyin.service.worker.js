...
/** @type {string} */
const CACHE_VERSION = '1780208582|30856370';
/** @type {string} */
const CACHE_PREFIX = 'CQUDouyin-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'CQUDouyin.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["CQUDouyin.html","CQUDouyin.js","CQUDouyin.offline.html","CQUDouyin.icon.png","CQUDouyin.apple-touch-icon.png","CQUDouyin.audio.worklet.js","CQUDouyin.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["CQUDouyin.wasm","CQUDouyin.pck"];
